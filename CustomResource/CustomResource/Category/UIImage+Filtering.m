...
-(UIImage*)sepia
{
	...
	else
	{
        ...
        (void)(free(reds)), (void)(free(greens)), (void)(free(blues)), (void)(free(tmpRed)), (void)(free(tmpGreen)), (void)(free(tmpBlue)), (void)(free(finalRed)), (void)(free(finalGreen)), free(finalBlue);
		CGContextRelease(bmContext);
