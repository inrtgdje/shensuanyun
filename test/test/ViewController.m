...
//  test
//
//  Created by 汤天明 on 2017/4/7.
//  Copyright © 2017年 汤天明. All rights reserved.
//
...
@property (weak, nonatomic) IBOutlet UILabel *elaborateMoney;

@end

@implementation ViewController
- (IBAction)numberChangeToElaborate:(UIButton *)sender
{
    NSString *elaborateNumber = [self toCapitalLetters:self.moneyText.text];
    
        self.elaborateMoney.text = elaborateNumber;
}
